    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            UNITY_INSTANCING_BUFFER_END(Props)
                ...
                // this method creates a shader that changes the color of the object faces depending on the normal of each face
                void colorChange(inout SurfaceOutputStandard o) {
                // color depends on o.Normal, _ColorMax and _ColorMin
                float3 n = o.Normal;
                float3 color = _ColorMin + (_ColorMax - _ColorMin) * (n + 1) / 2;
                o.Albedo = color;
